        ...
        register.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                if(TextUtils.isEmpty(txt_email) || TextUtils.isEmpty(txt_password)|| TextUtils.isEmpty(name)){
                    ...
                    Toast.makeText( RegisterActivity.this, "Password or too short", Toast.LENGTH_SHORT).show();
                } else{
                    ...
                    db.collection("userslist").document(txt_email)
                        ...
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void unused) {
                                Toast.makeText( RegisterActivity.this, "Success, in Firestore", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText( RegisterActivity.this, "Failed, not in Firestore", Toast.LENGTH_SHORT).show();
                            }
                        });
                }
            }
        ...
        auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(RegisterActivity.this, "User existing or no connexion", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
